...
public class PlayerMovementScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetAxis("Horizontal") == 0f && Input.GetAxis("Vertical") == 0f && isGrounded)
        {
            rigidbody.velocity = new Vector3(Mathf.SmoothDamp(rigidbody.velocity.x, 0f, ref dampVolumeX, dampTime), rigidbody.velocity.y, Mathf.SmoothDamp(rigidbody.velocity.z, 0f, ref dampVolumeZ, dampTime));
        }
