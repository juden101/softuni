...
/// <summary>
/// Data structure ReversedList<T> that holds a sequence of elements of generic type T. It holds a sequence of items in reversed order. The structure should have some capacity that grows twice when it is filled. 
/// </summary>
...
public class ReversedList<T> : IEnumerable<T>
{
    ...
    /// <summary>
    /// Allows iteration over the elements in a foreach loop in a reversed order of their addition
    /// </summary>
    /// <returns></returns>
