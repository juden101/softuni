namespace TravelAgency
{
    ...
    /// <summary>
    /// Defines a catalog, holding tickets(air ticket, bus ticket or train ticket)
    /// and a set of commands to add, delete or search tickets.
    /// </summary>
    public interface ITicketCatalog
    {
        /// <summary>
        /// Adds air ticket to the catalog by given flightNumber, departure and arrival airports, airline company,
        /// departure date and price of the ticket.
        /// </summary>
        /// <param name="flightNumber">The numer of the flight</param>
